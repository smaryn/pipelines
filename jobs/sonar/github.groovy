node('master') {
  properties([buildDiscarder(logRotator(artifactDaysToKeepStr: '', artifactNumToKeepStr: '', daysToKeepStr: '', numToKeepStr: '3')),
    parameters([choice(choices: ['ssh', 'http'], description: 'Protocol to be used for access to github', name: 'PROTOCOL'),
                string(defaultValue: '0.1', description: 'Version to pass to SonarQube', name: 'VERSION'),
